export const ProjectData = [
  {
    ...
    description:
      "Ecommerce website built with the MERN stack with React context API for state management ,pure css for style and CRUD operation implemented for the admin to crete,update,edit and delete products",
  ...
  },
  {
    ...
    description:
      "Airbnb Clone App is made using reactjs and nodejs.CRUD operation implemented for the app.To Create Update,Read and Delete",
    tags: ["ReactJs", "NodeJs", "MongoDB", "ExpressJs"],
